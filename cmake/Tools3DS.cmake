...
if(NOT TEX3DS)
	...
	find_program(TEX3DS tex3ds ${DEVKITARM}/bin)
	if(TEX3DS)
...
function(add_cia_target target RSF IMAGE SOUND ROMFS)
	get_filename_component(target_we ${target} NAME_WE)
	if(${ARGC} GREATER 7)
		set(APP_TITLE ${ARGV5})
		set(APP_DESCRIPTION ${ARGV6})
		set(APP_AUTHOR ${ARGV7})
	endif()
	if(${ARGC} EQUAL 9)
		set(APP_ICON ${ARGV8})
	endif()
...
macro(__add_t3s LIBTARGET OUTPUT_T3X OUTPUT_D OUTPUT_H INPUT)
	execute_process(COMMAND ${TEX3DS} -i ${INPUT} -o ${OUTPUT_T3X} -d ${OUTPUT_D} -H ${OUTPUT_H}
					WORKING_DIRECTORY ${CMAKE_CURRENT_LIST_DIR})
endmacro()
